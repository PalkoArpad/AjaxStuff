...
var updateInterval = 2000; //how many miliseconds to wait to get new msg
...
{
    //if debugMode is true, display error message with more technical details
...
function readMessages(data, textStatus)
{
    ...
    if(data.messages.length > 0) {
        //check to see if the first message has been already received
        //and if so ignore the rest of messages
...
$(document).ready(function()
{
    ...
    $('#userName').blur(
        //function that ensures that the username is never empty and if
        //so a random name is generated
        function(e) {
    ...
    //populate the username field with the default value
