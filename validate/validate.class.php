<?php
//load error handler and database config
...
//class supports AJAX and PHP web form validation
    class Validate
    {
        ...
        private function validateBirthYear($value)
        {
            ...
            $date = explode('#', $value);
            //date can't be valid if the is no day, month or year
            if(!$date[0]) return 0;
        ...
        //check if the user has read the terms of use
